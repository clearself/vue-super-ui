/*
  ...
  return fetch('https://api.github.com/repos/themusecatcher/vue-super-ui/contents/package.json?ref=master', {
    headers: {
  ...
  return fetch('https://raw.githubusercontent.com/themusecatcher/vue-super-ui/master/package.json')
*/
export function fetchVersion () {
  return fetch('https://api.github.com/repos/clearself/vue-super-ui/contents/package.json?ref=master', {
    headers: {
      // See https://docs.github.com/en/rest/overview/media-types
      Accept: 'application/vnd.github.v3.raw',
      // See https://docs.github.com/en/rest/guides/getting-started-with-the-rest-api#authentication
